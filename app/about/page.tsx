        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-secondary/50 backdrop-blur border border-secondary rounded-lg p-8 hover:bg-secondary/70 transition-colors">
              ...
              <div className="bg-secondary/50 backdrop-blur border border-secondary rounded-lg p-8 hover:bg-secondary/70 transition-colors">
                <h3 className="text-2xl font-bold text-accent mb-4">Philosophy</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    <span className="text-accent font-bold">✓</span>
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-accent/20 to-accent/5 backdrop-blur border border-accent/30 rounded-lg p-8 text-center"
            >
